...
-Un lenguaje de programación es un conjunto Un lenguaje de programación es un conjunto de palabras y sintaxis que en conjunto proporcionan una serie de instrucciones que le permiten a un programador escribir secuencias de ordenes y algoritmos con el fin de controlar el comportamiento físico y/o lógico de una computadora con el objetivo de que se cumplan ciertas acciones.
 
-Algunos ejemplos son Java, PHP, Python, C++, .NET, entre otros. 

## ¿ Qué es Java?

-Java es un lenguaje de programaicón y tecnología pensada para desarrollo de aplicaciones de gran envergadura, altamente escalables, de gran inntegración con otras tecnologías muy robustas.
 ...
 **J2EE (Java 2 Enterprise Edition)** : tiene como objetivo el **desarrollo de aplicaciones empresariales**, de gran envergadura. Contempla ambientes web, como los ambientes manejados por servidores de aplicaicón. Las tecnologías principales incluidas en esta área son Selvets, JSP, EJB, entre otras.
...
-Un IDE consta, de un editor de código fuente, herramientas de construcción automáticas y un depurador. Algunos de ellos contienen también un compilador, un intérprete, o ambos, como el caso de NetBeans o Eclipse.

## ¿ Qué necesitamos para programar en Java ?

-Un **IDE**, en este caso utilizaremos NetBeans 8.2
