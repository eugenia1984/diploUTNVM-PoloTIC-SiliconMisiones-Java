...
public class Pelicula {
    ...
    //constructores
    public Pelicula(){}
    //el this hace referencia ala tributo de la calse, ya que es igual al 
    //nombre de la variable que recibo por parametro
    //constructor que me setea: nombre, anioEstreno
    public Pelicula(String nombre, String anioEstreno) {
        this.nombre = nombre;
        this.anioEstreno = anioEstreno;
    }
    //un nuevo contructor que también me settea:nombre, anioEstreno, genero
    public Pelicula(String nombre, String anioEstreno, Genero genero) {
        this.nombre = nombre;
        this.anioEstreno = anioEstreno;
        this.genero = genero;
    }
    //un nuevo contructor que también me settea:nombre, anioEstreno, genero, paisDeorigen
    public Pelicula(String nombre, String anioEstreno, Genero genero, PaisDeOrigen paisDeOrigen) {
        this.nombre = nombre;
        this.anioEstreno = anioEstreno;
        this.genero = genero;
        this.paisDeOrigen = paisDeOrigen;
    }
    //un nuevo contructor que también me settea:nombre, anioEstreno, genero, paisDeorigen, calificacion
    public Pelicula(String nombre, String anioEstreno, Genero genero, PaisDeOrigen paisDeOrigen, Calificacion calificacion) {
        this.nombre = nombre;
        this.anioEstreno = anioEstreno;
        this.genero = genero;
        this.paisDeOrigen = paisDeOrigen;
